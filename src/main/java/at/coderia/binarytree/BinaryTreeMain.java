...
public class BinaryTreeMain {
    ...
    static Integer[] testdata2 = {2, 5, 6, 8, 10, 13, 15, 15, 23, 24, 27, 29, 31, 38, 39, 43, 45, 50, 51, 53, 56, 59, 65, 66, 67, 68, 78, 80, 81, 83, 84, 85, 87, 88, 90, 91, 92, 93, 100};
    ...
    public static void main(String[] args) {
        ...
        List<Comparable<Person>> objects = new ArrayList<>();
        ...
        List<Integer> o2 = Arrays.asList(testdata2);
        ...
        BinaryTree<Date> tree3 = new BinaryTree<>();
        List<Comparable<Date>> o3 = new ArrayList<>();
